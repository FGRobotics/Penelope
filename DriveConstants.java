...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(9, 0, 4, 10);
    ...
    public static double GEAR_RATIO = .8225; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 10; // 13in
